...
describe CodesController do
  ...
  describe "GET new" do
    it "assigns a new code as @code" do
      ...
      assigns(:code).should be_a_new(Code)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created code as @code" do
        post :create, {:code => valid_attributes}, valid_session
        assigns(:code).should be_a(Code)
        assigns(:code).should be_persisted
      end

      it "redirects to the created code" do
        post :create, {:code => valid_attributes}, valid_session
        response.should redirect_to(Code.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved code as @code" do
        ...
        post :create, {:code => {  }}, valid_session
        assigns(:code).should be_a_new(Code)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested code" do
        ...
        Code.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => code.to_param, :code => { "these" => "params" }}, valid_session
      end
      ...
      it "redirects to the code" do
        code = Code.create! valid_attributes
        put :update, {:id => code.to_param, :code => valid_attributes}, valid_session
        response.should redirect_to(code)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the code as @code" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Code.any_instance.stub(:save).and_return(false)
        put :update, {:id => code.to_param, :code => {  }}, valid_session
        assigns(:code).should eq(code)
      end
